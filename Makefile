...
run_all:
	bin/gen centroid 64 centroid.point
	bin/gen data 65536 data.point 64
...
test:
	...
	bin/plot result centroid.point data.point result_seq.class     result_seq.png
	bin/plot result centroid.point data.point result_pthread.class result_pthread.png
